...
my = readIntensity("yellow-tungsten.png", "yellow-tungsten", "Лампа накаливания", "Жёлтый лист")
mb = readIntensity("blue-tungsten.png", "blue-tungsten", "Лампа накаливания", "Синий лист")
mw = readIntensity("white-tungsten.png", "white-tungsten", "Лампа накаливания", "Белый лист")
mr = readIntensity("red-tungsten.png", "red-tungsten", "Лампа накаливания", "Красный лист")
mg = readIntensity("green-tungsten.png", "green-tungsten", "Лампа накаливания", "Зелёный лист")
mc = readIntensity("white-mercury.png", "white-mercury", "Ртутная лампа", "Белый лист")
mn = calibration(mc, my)
n = len(mn)

albmy = albedo_znach(my, mw, n)
albmb = albedo_znach(mb, mw, n)
albmw = albedo_znach(mw, mw, n)
albmr = albedo_znach(mr, mw, n)
albmg = albedo_znach(mg, mw, n)


# Построение графика интенсивностей и альбедо
intensities(my, mb, mw, mr, mg, mn)
albedos(albmy, albmb, albmw, albmr, albmg, mn)
